...
3. Git add, commit and push origin `feature_new_motd`:
    ...
    ```
4. Switch over to the CD4PE browser to ensure your **Regex** `feature_new_config` pipeline runs.  You may need to click on "New Events". Wait until the run completes successfully before you continue (about 2-3 minutes).
